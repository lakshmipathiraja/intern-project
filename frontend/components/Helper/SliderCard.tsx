    ...
    <div className='flex flex-wrap sm:flex-nowrap items-center space-x-10'>
        ...
        <div className='mt-6 mb-7'>
            ...
            <p className='mt-6 text-gray-800 w-[95%] md:w-[80%] text-xs md:text-sm lg:text-base font-semibold text-opacity-65'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur fuga maxime magni tempore molestiae est. Sint nostrum, accusamus debitis obcaecati rerum ea laudantium fugiat maiores.
            </p>
            <div className='mt-7'>
