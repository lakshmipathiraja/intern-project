...
function About() {
  return (
    <div className='pt-16 pb-18' id='About'>
        {/* define grid */}
        <div className='w-4/5 mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-16'>
            ...
            <div>
                ...
                <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-6xl mt-8 font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[3.9rem] text-gray-800'>
                    ...
                    <p className='mt-4 text-gray-600'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia animi culpa sit dolorem laboriosam et quod asperiores? Ipsam, accusamus! Doloribus ipsa ipsam eum dolorum.
                    </p>
            ...
            <div>
                <div>
                    ...
                    <div className='mt-'>
                        <h1 className='text-xl md:text-2xl text-opacity-70 text-black font-bold'>
                            Flexible Schedule
                        </h1>
                        <p className='w-[90%] lg:w-[70%] text-base text-black text-opacity-60'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam, accusantium.</p>
                    </div>
                </div>
